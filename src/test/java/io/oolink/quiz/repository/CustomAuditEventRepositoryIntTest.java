package io.oolink.quiz.repository;

import io.oolink.quiz.OolinkQuizApplicationApp;
import io.oolink.quiz.config.Constants;
import io.oolink.quiz.config.audit.AuditEventConverter;
import io.oolink.quiz.domain.PersistentAuditEvent;
...
import static io.oolink.quiz.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
